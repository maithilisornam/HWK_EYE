$hrdwrInfo =  Get-ItemProperty HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\*, 
                 HKLM:\Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\* | 
    Where-Object {$_.DisplayName -like '*'} |
    Select-Object DisplayName,Name,  DisplayVersion, Path, Publisher, InstallDate | 
    ConvertTo-JSON
# Output to JSON file
$hrdwrInfo | Out-File "$PSScriptRoot\hrdwrInfo.json" -Encoding "UTF8"
